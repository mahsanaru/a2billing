...
CREATE TABLE IF NOT EXISTS `cc_alarm` (
  ...
  `datelastrun` timestamp NOT NULL default '1971-01-01 00:00:00',
...
CREATE TABLE IF NOT EXISTS `cc_call` (
  ...
  `stoptime` timestamp NOT NULL default '1971-01-01 00:00:00',
...
CREATE TABLE IF NOT EXISTS `cc_callback_spool` (
  ...
  `last_attempt_time` timestamp NOT NULL default '1971-01-01 00:00:00',
  `manager_result` varchar(60) collate utf8_bin default NULL,
  `agi_result` varchar(60) collate utf8_bin default NULL,
  `callback_time` timestamp NOT NULL default '1971-01-01 00:00:00',
...
CREATE TABLE IF NOT EXISTS `cc_campaign` (
  ...
  `creationdate` timestamp NOT NULL default CURRENT_TIMESTAMP,
  `startingdate` timestamp NOT NULL default '1971-01-01 00:00:00',
  `expirationdate` timestamp NOT NULL default '1971-01-01 00:00:00',
  `description` mediumtext collate utf8_bin,
...
CREATE TABLE IF NOT EXISTS `cc_card` (
  `id` bigint(20) NOT NULL auto_increment,
  `creationdate` timestamp NOT NULL default CURRENT_TIMESTAMP,
  `firstusedate` timestamp NOT NULL default '1971-01-01 00:00:00',
  `expirationdate` timestamp NOT NULL default '1971-01-01 00:00:00',
  ...
  `currency` char(3) collate utf8_bin default 'USD',
  `lastuse` timestamp NOT NULL default '1971-01-01 00:00:00',
  ...
  `servicelastrun` timestamp NOT NULL default '1971-01-01 00:00:00',
...
CREATE TABLE IF NOT EXISTS `cc_card_subscription` (
  ...
  `stopdate` timestamp NOT NULL default '1971-01-01 00:00:00',
...
CREATE TABLE IF NOT EXISTS `cc_did_use` (
  ...
  `releasedate` timestamp NOT NULL default '1971-01-01 00:00:00',
...
CREATE TABLE IF NOT EXISTS `cc_voucher` (
  `id` bigint(20) NOT NULL auto_increment,
  `creationdate` timestamp NOT NULL default CURRENT_TIMESTAMP,
  `usedate` timestamp NOT NULL default '1971-01-01 00:00:00',
  `expirationdate` timestamp NOT NULL default '1971-01-01 00:00:00',
