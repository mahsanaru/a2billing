...
ALTER TABLE cc_subscription_fee ADD startdate TIMESTAMP NOT NULL DEFAULT '1971-01-01 00:00:00',
ADD stopdate TIMESTAMP NOT NULL DEFAULT '1971-01-01 00:00:00';
...
ALTER TABLE cc_card_subscription ADD last_run TIMESTAMP NOT NULL DEFAULT '1971-01-01 00:00:00';
ALTER TABLE cc_card_subscription ADD next_billing_date TIMESTAMP NOT NULL DEFAULT '1971-01-01 00:00:00';
UPDATE cc_card_subscription SET next_billing_date = NOW();
ALTER TABLE cc_card_subscription ADD limit_pay_date TIMESTAMP NOT NULL DEFAULT '1971-01-01 00:00:00';
