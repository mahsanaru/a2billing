...
ALTER TABLE cc_subscription_fee ADD COLUMN startdate TIMESTAMP NOT NULL DEFAULT '1971-01-01 00:00:00';
ALTER TABLE cc_subscription_fee ADD COLUMN stopdate TIMESTAMP NOT NULL DEFAULT '1971-01-01 00:00:00';
...
ALTER TABLE cc_card_subscription ADD COLUMN last_run TIMESTAMP NOT NULL DEFAULT '1971-01-01 00:00:00';
ALTER TABLE cc_card_subscription ADD COLUMN next_billing_date TIMESTAMP NOT NULL DEFAULT '1971-01-01 00:00:00';

UPDATE cc_card_subscription SET next_billing_date = NOW();
ALTER TABLE cc_card_subscription ADD COLUMN limit_pay_date TIMESTAMP NOT NULL DEFAULT '1971-01-01 00:00:00';
